...
<body>
	<center>
		...
		<font color="black" size="5" ><font color="red">Youtube :</font> <a href="">Click HEre</a><br><br></font>
		<h2>© ARON-TN 2023</h2>
	</body>
	</html>\r\n.\r\n'''
			s.send(headers)
...
(.-./`-'\.-.)  \033[93m$$    $$/ $$ | $/  $$ |   $$ |   $$ |       \033[0;96m(.-./`-'\.-.) 
 `-'     `-'    \033[93m$$$$$$/  $$/      $$/    $$/    $$/         \033[0;96m`-'     `-'
               \033[91m[\033[92m+\033[91m]\033[1m(C)opyright > 2021\033[91m [\033[92m+\033[91m]
              \033[91m[\033[92m+\033[91m]\033[95m SMTP CRACKER  \033[91m[\033[92m+\033[91m]
             \033[91m[\033[92m+\033[91m]\033[92m         \033[91m[\033[92m+\033[91m]
            \033[91m[\033[92m+\033[91m]\033[94m TELEGRAM: >  @laker305\033[91m[\033[92m+\033[91m]
           \033[91m[\033[92m+\033[91m]   Instagram > @e9_Z_  \033[91m[\033[92m+\033[91m]''')
ms0g ="\n\033[93m\033[0;96m \033[91m (%s)\033[92m "%vers
for i in ms0g:
        sys.stdout.write(i)
        sys.stdout.flush()
        time.sleep(0.02)
